        ...
        <div className="menu-content">
            <div className="sizes-container">
                ...
                <div className="cup-container">
                    <span className="subtitle">Cup (up to 3 flavors):</span>
                ...
                <div className="cone-container">
                    <span className="subtitle">Cone:</span>
                    <table className="cone-table">
                        <tbody>
                            <tr>
                                <td>1 Scoop</td>
                                <td>-</td>
            ...
            <div className="flavor-container"><span className="title">Flavors</span>
